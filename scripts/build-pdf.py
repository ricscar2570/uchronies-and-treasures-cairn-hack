...
def story():
    ...
    sp(2),
    T(["Floors","Era","What's Here","Danger","Treasure"],
      [["Basement","Mixed","Flooded corridors, old casino vault","1 echo in vault, currents","Pre-Oculus cash (d6 x $500), gold chips"],
       ["1-2 (Lobby)","1934+2080","4 civilians, reception","Social dilemma (evacuate or leave?)","Cash register, guest ledger"],
       ["3-5 (Service)","1934","Kitchens, laundry, staff quarters","1 temporal ghost (harmless)","Chef's knife (d6), wine collection ($300)"],
       ["6-10","1934","Luxury rooms, ballroom on floor 8","1 echo on floor 7, temporal loop on floor 9","Jewelry ($500), device on floor 8"],
       ["11-14","Transitional","Architecture shifts mid-corridor","STR save at each interface or d6 damage","Anti-rejection cache, 8 weeks supply"],
       ["15-24","2080","Empty apartments, gravity anomalies","2-3 echoes patrol, structural instability","Electronics ($200), Division field notes"],
       ["25-26","Mixed","Corridors shift eras every 10 min","Forced contamination check per floor","Oculus fragment shard (class-C, $2,000)"],
       ["27 (Suite 2701)","Frozen","Time nearly stopped, light bends","Zhou's 3 mercenaries inside","The objective: class-A Oculus fragment"],
       ["Roof","2080","Helicopter extraction point","Final contamination check, exposed","Extraction"]],
      [FW*0.12, FW*0.10, FW*0.22, FW*0.26, FW*0.30], full=True),
    sp(3),
